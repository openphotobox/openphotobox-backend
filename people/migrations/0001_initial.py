    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='confirmed_faces', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'faces',
