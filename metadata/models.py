...
class AssetMetadata(models.Model):
    ...
    asset = models.OneToOneField("assets.Asset", on_delete=models.CASCADE, related_name="metadata")
...
class ClipEmbedding(models.Model):
    ...
    # One-to-one relationship with Asset
    asset = models.OneToOneField("assets.Asset", on_delete=models.CASCADE, related_name="clip_embedding")
...
class XmpSidecar(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    asset = models.OneToOneField("assets.Asset", on_delete=models.CASCADE, related_name="xmp_sidecar")
