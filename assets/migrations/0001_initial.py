    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backend_type', models.CharField(choices=[('s3', 'Amazon S3'), ('minio', 'MinIO'), ('local', 'Local File System')], max_length=10)),
        ...
        migrations.AddField(
            model_name='album',
            name='cover_asset',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cover_for_albums', to='assets.asset'),
        ),
        migrations.CreateModel(
            name='StorageBucket',
            fields=[
        ...
        migrations.AddField(
            model_name='asset',
            name='storage_bucket',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='assets', to='assets.storagebucket'),
        ),
        migrations.CreateModel(
            name='UploadBatch',
            fields=[
                ...
                ('default_keywords', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=100), blank=True, default=list, size=None)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('completed_at', models.DateTimeField(blank=True, null=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('default_album', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='assets.album')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('size', models.CharField(choices=[('xs', 'Extra Small (150px)'), ('sm', 'Small (300px)'), ('md', 'Medium (600px)'), ('lg', 'Large (1200px)')], max_length=2)),
                ('storage_key', models.CharField(max_length=1024)),
                ('width', models.PositiveIntegerField()),
                ('height', models.PositiveIntegerField()),
